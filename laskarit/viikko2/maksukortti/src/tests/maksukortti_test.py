...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_kun_saldoa_vain_maukkaan_lounaan_verran(self):
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
    ...
    def test_edullinen_lounas_kun_saldoa_edullisen_lounaan_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_syo_maukkaasti_ei_vie_saldoa_negatiiviseksi(self):
        ...
        self.kortti.syo_edullisesti()
        self.kortti.syo_maukkaasti()
        self.assertEqual("Kortilla on rahaa 2.5 euroa", str(self.kortti))
